...
TEST_F(MovementModelInSquareTest, ValidLinearTrajectoryInSquare) {
    ...
    std::optional<BURST::Segment2D<BURST::AlgebraicKernel>> maybe_path = movement_model.generatePath(origin, CGAL_PI/4, *this->configuration_geometry);
...
TEST_F(MovementModelInSquareTest, ValidLinearTrajectoryAlongEdgeInSquare) {
    ...
    std::optional<BURST::Segment2D<BURST::AlgebraicKernel>> maybe_path = movement_model.generatePath(origin, 0, *this->configuration_geometry);
...
TEST_F(MovementModelInConcaveTest, ValidLinearTrajectoryInConcave) {
    ...
    std::optional<BURST::Segment2D<BURST::AlgebraicKernel>> maybe_path = movement_model.generatePath(origin, CGAL_PI/2, *this->configuration_geometry);
